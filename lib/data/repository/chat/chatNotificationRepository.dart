...
class ChatNotificationsRepository {
  ...
  Future<void> setBackgroundChatNotificationData({required List<ChatNotificationData> data}) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.reload();
    prefs.setStringList(chatNotificationsBackgroundItemKey, data.map((e) => e.toJson()).toList());
  }
