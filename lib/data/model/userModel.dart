...
class UserDetailsModel {
  ...
  factory UserDetailsModel.fromMap(final Map<String, dynamic> map) => UserDetailsModel(
        ...
        userLoginType: map["loginType"] != null ? map["loginType"] as String : null,
        countryCodeName: map["countryCodeName"] != null ? map["countryCodeName"] as String : null,
      );
  ...
  UserDetailsModel fromMapCopyWith(final Map<String, dynamic> map) => UserDetailsModel(
        ...
        countryCodeName:
            map["countryCodeName"] != null ? map["countryCodeName"] as String : countryCodeName,
        userLoginType: map["loginType"] != null ? map["loginType"] as String : userLoginType,
      );
