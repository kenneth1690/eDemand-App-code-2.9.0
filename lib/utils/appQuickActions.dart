  ...
  static void initAppQuickActions() {
    ...
    AppQuickActions().quickActions.initialize((final String shortcutType) {
      if (shortcutType == 'explore') {
        UiUtils.bottomNavigationBarGlobalKey.currentState?.selectedIndexOfBottomNavigationBar.value = 0;
      } else if (shortcutType == 'booking') {
        UiUtils.bottomNavigationBarGlobalKey.currentState?.selectedIndexOfBottomNavigationBar.value = 1;
      } else if (shortcutType == 'category') {
        UiUtils.bottomNavigationBarGlobalKey.currentState?.selectedIndexOfBottomNavigationBar.value = 2;
      } else {
        UiUtils.bottomNavigationBarGlobalKey.currentState?.selectedIndexOfBottomNavigationBar.value = 3;
      }
    });
    //
  }
