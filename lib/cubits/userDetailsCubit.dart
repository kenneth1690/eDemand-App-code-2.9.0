...
class UserDetailsCubit extends Cubit<UserDetailsState> {
  ...
  Future<void> getUserDetailsFromServer() async {
    try {
      final UserDetailsModel userDetailsModel = await _authenticationRepository.getUserDetails();
      //
  ...
  void loadUserDetails() {
    final Map detailsMap = HiveRepository.getAllValueOf(boxName: HiveRepository.userDetailBoxKey);
