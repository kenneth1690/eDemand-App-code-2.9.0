...
class CartCubit extends Cubit<CartState> {
  ...
  String getCartTotalAmount({required bool isAtStoreBooked, required String isFrom}) {
    if (state is CartFetchSuccess) {
  ...
  String getCartSubTotalAmount({required bool isAtStoreBooked, required String isFrom}) {
    if (state is CartFetchSuccess) {
      final Cart cartData = isFrom == "cart"
          ? (state as CartFetchSuccess).cartData
          : (state as CartFetchSuccess).reOrderCartData!;
