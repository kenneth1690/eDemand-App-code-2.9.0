...
class AddressSelector extends StatelessWidget {
  ...
  final String address, mobileNumber, addressPincodeAndCountry, addressAreaAndCity, addressType;
  ...
  BoxDecoration selectedItemBorderStyle({required BuildContext context}) => BoxDecoration(
  ...
  BoxDecoration normalBoxDecoration({required BuildContext context}) => BoxDecoration(
        color: context.colorScheme.secondaryColor,
        borderRadius: BorderRadius.circular(UiUtils.borderRadiusOf10),
      );
