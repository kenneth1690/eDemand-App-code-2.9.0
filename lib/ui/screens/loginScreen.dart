...
//
      ...
      child: Scaffold(
        ...
        body: CustomContainer(
          ...
          child: BlocListener<CheckIsUserExistsCubit, CheckIsUserExistsState>(
            listener: (final BuildContext context, final CheckIsUserExistsState state) =>
                ...
                children: [
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(width: context.screenWidth * 0.7, child: LinearDivider()),
                  ...
                  Positioned.directional(
                    ...
                    child: CustomSizedBox(
                      ...
                      child: Column(
                        children: [
                          CustomText("by_continue_agree".translate(context: context),
                              textAlign: TextAlign.center,
                              fontWeight: FontWeight.w400,
  ...
  Widget _buildSignInWithMobileButton() =>
      BlocConsumer<CheckIsUserExistsCubit, CheckIsUserExistsState>(
        ...
        builder: (context, checkIsUserExistsState) {
          final bool isCheckingUserExists = checkIsUserExistsState is CheckIsUserExistsInProgress;
                  ...
                  builder: (context, numberLength, _) {
                    return SizedBox(
                      ...
                      child: CustomRoundedButton(
                          ...
                          widthPercentage: 1,
                          onTap: () {
                            if (verifyPhoneNumberState is SendVerificationCodeInProgressState) {
                              return;
                            } else if (checkIsUserExistsState is CheckIsUserExistsInProgress) {
                              return;
                            }
                            _onContinueButtonClicked();
                          },
                          backgroundColor: ((numberLength < UiUtils.minimumMobileNumberDigit)
                          ...
                          child: (isVerifyingPhoneNumber || isCheckingUserExists)
                              ? const SizedBox(
                                  height: 20,
                                  width: 20,
                              ...
                              : CustomSvgPicture(
                                  ...
                                  color: ((numberLength < UiUtils.minimumMobileNumberDigit)
                                      ? context.colorScheme.lightGreyColor
                                      : (numberLength > UiUtils.maximumMobileNumberDigit)
                                          ? AppColors.redColor
  ...
  Widget _buildSignInWithGoogleButton() {
    return BlocBuilder<CheckIsUserExistsCubit, CheckIsUserExistsState>(
      builder: (context, verificationState) {
        final bool isVerificationLoading = verificationState is CheckIsUserExistsInProgress &&
        ...
        return BlocConsumer<GoogleLoginCubit, GoogleLoginState>(
          listener: (context, state) {
            if (state is GoogleLoginFailureState) {
              UiUtils.showMessage(
                  context,
                  findFirebaseError(state.errorMessage.toString()).translate(context: context),
                  MessageType.error);
          ...
          builder: (context, state) {
            ...
            return CustomRoundedButton(
              ...
              backgroundColor: context.watch<SendVerificationCodeCubit>().state
                      ...
                      context.watch<CheckIsUserExistsCubit>().state is CheckIsUserExistsInProgress
  ...
  Future<void> _handleCheckIsUserExitListener(CheckIsUserExistsState state) async {
    if (state is CheckIsUserExistsFailure) {
      UiUtils.showMessage(
        context,
        state.errorMessage.translate(context: context),
      ...
      if (state.statusCode == '103') {
        ...
        await AuthenticationRepository.loginUser(
          ...
          (final UserDetailsModel value) {
            ...
            //
            UiUtils.showMessage(context, "userLoggedInSuccessfully".translate(context: context),
                MessageType.success);
            //
  ...
  void _handleVerifyPhoneNumberListener(
      BuildContext context, SendVerificationCodeState sendVerificationCodeState) {
    if (sendVerificationCodeState is SendVerificationCodeSuccessState) {
      Navigator.pushNamed(
        ...
        arguments: {
          ...
          'countryCode': countryCode,
          'source': widget.source,
          "userAuthenticationCode": sendVerificationCodeState.userAuthenticationCode,
      ...
      errorMessage = sendVerificationCodeState.error.toString().translate(context: context);
