...
class _ProfileScreenState extends State<ProfileScreen> {
          ...
          child: Row(
            children: [
              ...
              if (showDarkModeToggle) ...[
                CustomSwitch(
                  thumbColor: context.read<AppThemeCubit>().state.appTheme == AppTheme.dark
                      ? Colors.green
                      : Colors.red,
                  ...
                  children: [
                              ...
                              if (token == "") {
                                ...
                                Navigator.pushNamed(
                                  ...
                                  arguments: {
                                    ...
                                    "isNewUser": false,
                                    "countryCodeName": userDetails.countryCodeName,
                                    "countryCode": userDetails.countryCode,
                                    "phoneNumberWithOutCountryCode": userDetails.phone,
                                    "loginType": userDetails.userLoginType == "phone"
                                        ? LogInType.phone
                                  ...
                                  children: [
                                    CustomContainer(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: (HiveRepository.getUserProfilePictureURL == null ||
                                          ...
                                          if (token != "") ...{
                                            Padding(
                                              ...
                                              child: _getText(
                                                ...
                                                fontColor: context.colorScheme.blackColor,
                                              ),
                                            ),
                                            Padding(
                                              padding: const EdgeInsets.only(bottom: 4),
                    ...
                    if (token != "") ...[
                      ...
                      backgroundContainer(
                        child: Column(
                          children: [
                            _buildSectionTitleWidget(title: 'content'.translate(context: context)),
                    ...
                    backgroundContainer(
                      child: Column(
                        children: [
                          _buildSectionTitleWidget(title: 'preference'.translate(context: context)),
                          _buildListItemWidget(
                    ...
                    backgroundContainer(
                      child: Column(
                        children: [
                          _buildSectionTitleWidget(title: 'legal'.translate(context: context)),
                          _buildListItemWidget(
                    ...
                    backgroundContainer(
                      child: Column(
                        children: [
                          _buildSectionTitleWidget(title: 'others'.translate(context: context)),
                          _buildListItemWidget(
                        ...
                        child: Column(
                          children: [
                            ...
                            _buildListItemWidget(
                              ...
                              title: 'logoutFromApp'.translate(context: context),
                    ...
                    SizedBox(
                        ...
                        child: Center(
                          child: CustomText(
                            "${"appName".translate(context: context)} ${Platform.isAndroid ? "v$latestVersionOfAndroid" : "v$latestVersionOfIOS"}",
                            fontSize: 14,
                            fontWeight: FontWeight.w400,
                            color: context.colorScheme.lightGreyColor,
                          ),
  ...
  Future<void> _handleBecomeProviderClick(BuildContext context) async {
    final String providerAppURL = context.read<SystemSettingCubit>().getProviderAppURL();

    if (await canLaunchUrl(Uri.parse(providerAppURL))) {
      try {
        launchUrl(Uri.parse(providerAppURL), mode: LaunchMode.externalApplication);
      } catch (e) {
        UiUtils.showMessage(
          context,
  ...
  void _handleShareAppClick(BuildContext context) {
    try {
      Share.share(context.read<SystemSettingCubit>().getCustomerAppURL());
    } catch (e) {
      UiUtils.showMessage(
        context,
        'somethingWentWrong'.translate(context: context),
  ...
  Future<void> _handleRateAppClick(BuildContext context) async {
    final String customerAppURL = context.read<SystemSettingCubit>().getCustomerAppURL();
    if (await canLaunchUrl(Uri.parse(customerAppURL))) {
      launchUrl(Uri.parse(customerAppURL), mode: LaunchMode.externalApplication);
    } else {
      UiUtils.showMessage(context, "unableToOpen".translate(context: context), MessageType.error);
    }
  }
}
