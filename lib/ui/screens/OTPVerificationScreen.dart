...
class _OtpVerificationScreenState extends State<OtpVerificationScreen> {
  ...
  Widget _buildResendButton(final BuildContext context, final resendOtpState) => Row(
        children: [
          Expanded(
          ...
          BlocConsumer<VerifyOtpCubit, VerifyOtpState>(
            ...
            builder: (final context, final verifyOtpState) => ValueListenableBuilder(
                ...
                return isCountDownCompleted.value
                    ? CustomInkWellContainer(
                        ...
                        child: CustomText(
                          ...
                          showUnderline: true,
                          textAlign: TextAlign.center,
                          underlineOrLineColor: Theme.of(context).colorScheme.accentColor,
                        ),
                      )
  ...
  Widget _resendCountDownButton() => Row(
        ...
        children: [
          ...
          countDownTimer.listenText(color: Theme.of(context).colorScheme.accentColor)
        ],
      );
  ...
  Widget build(final BuildContext context) => Scaffold(
        ...
        body: BlocListener<SendVerificationCodeCubit, SendVerificationCodeState>(
            ...
            child: BlocConsumer<ResendOtpCubit, ResendOtpState>(
              listener: (final BuildContext c, final ResendOtpState state) {
                if (state is ResendOtpSuccess) {
                  ...
                  UiUtils.showMessage(
                      context, 'otp_sent'.translate(context: context), MessageType.success);
                } else if (state is ResendOtpFail) {
                  UiUtils.showMessage(context, state.error.toString().translate(context: context),
                      MessageType.error);
                }
              },
  ...
  Future<void> _handleVerifyOtpListener(BuildContext context, VerifyOtpState verifyOtpState) async {
    if (verifyOtpState is VerifyOtpSuccess) {
      ...
      //
      UiUtils.showMessage(
          context, verifyOtpState.error.toString().translate(context: context), MessageType.error);
      //
      Future.delayed(Duration.zero, () {
        otpController.clear();
      });
