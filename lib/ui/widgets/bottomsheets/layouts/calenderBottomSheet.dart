                          ...
                          child: BlocConsumer<TimeSlotCubit, TimeSlotState>(
                            ...
                            builder: (final context, final state) {
                              ...
                              final Color disabledTimeSlotColor =
                                  context.colorScheme.lightGreyColor.withOpacity(0.35);
                              final Color selectedTimeSlotColor = context.colorScheme.accentColor;
                              final Color defaultTimeSlotColor = context.colorScheme.secondaryColor;
                              ...
                              const Color selectedTimeSlotTextColor = AppColors.whiteColors;
                              final Color defaultTimeSlotTextColor = context.colorScheme.blackColor;
