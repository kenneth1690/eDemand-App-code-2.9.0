...
class _MobileNumberFiledState extends State<MobileNumberFiled> {
  ...
  Widget build(final BuildContext context) => TextFormField(
        ...
        validator: (final value) => isValidMobileNumber(number: value!, context: context),
        onChanged: (number) {
          setState(() {
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: OutlineInputBorder(
            ...
            borderRadius: const BorderRadius.all(Radius.circular(UiUtils.borderRadiusOf10)),
          ),
          enabledBorder: OutlineInputBorder(
            borderSide:
                BorderSide(color: widget.borderColor ?? Theme.of(context).colorScheme.accentColor),
            borderRadius: const BorderRadius.all(Radius.circular(UiUtils.borderRadiusOf10)),
          ),
