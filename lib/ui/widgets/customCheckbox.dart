  ...
  Widget build(BuildContext context) {
    return Checkbox.adaptive(
      ...
      side: WidgetStateBorderSide.resolveWith(
        (states) => BorderSide(width: 1.0, color: context.colorScheme.accentColor),
      ),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(UiUtils.borderRadiusOf5)),
