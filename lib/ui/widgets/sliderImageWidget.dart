...
class SliderImageWidget extends StatefulWidget {
  ...
  const SliderImageWidget({Key? key, required this.sliderImages}) : super(key: key);
          ...
          CarouselSlider(
              options: CarouselOptions(
                ...
                autoPlayInterval: Duration(
                    milliseconds: sliderAnimationDurationSettings["sliderAnimationDuration"]),
                autoPlayAnimationDuration: Duration(
                    milliseconds: sliderAnimationDurationSettings["changeSliderAnimationDuration"]),
      ...
      children: [
        ...
        AnimatedContainer(
          duration: currentSliderImage == index
              ? Duration(milliseconds: sliderAnimationDurationSettings["sliderAnimationDuration"])
              : Duration.zero,
          width: currentSliderImage == index ? 30 : 8,
          curve: Curves.easeIn,
          margin: const EdgeInsets.symmetric(horizontal: 5),
        ...
        child: ClipRRect(
          ...
          child: sliderImage.sliderImage!.endsWith('.svg')
              ? SvgPicture.network(
                  ...
                  colorFilter: ColorFilter.mode(context.colorScheme.accentColor, BlendMode.srcIn),
              ...
              : CachedNetworkImage(
                  ...
                  width: context.screenWidth - 30,
                  fit: BoxFit.fill,
                  errorWidget: (BuildContext context, String url, final error) => const Center(
                    child: CustomSvgPicture(
                  ...
                  placeholder: (final BuildContext context, final String url) => const Center(
                    child: CustomSvgPicture(
                      svgImage: AppAssets.placeHolder,
                      width: 100,
                      height: 100,
